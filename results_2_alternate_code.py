"""
Results 2 Alternate Validation Script
====================================
Purpose:
- Clean, deterministic walk-forward validation
- Optional position randomization (off by default)
- Properly implements temperature scaling or isotonic regression

This script avoids:
- Double randomization
- Forced 50/50 class balancing
"""
